 ...
 */
package Ventanas;
import GestionAgroalimentaria.ProductoCongeladoAgua;
import java.util.ArrayList;

public class FormularioCongeladoAgua extends javax.swing.JFrame {

    /**
     * Creates new form FormularioCongeladoAgua
     */
    public FormularioCongeladoAgua() {
        initComponents();
    ...
    ArrayList<ProductoCongeladoAgua> productosCongeladosAgua = ProductoCongeladoAgua.cargarProductosDesdeArchivo();

        // Limpiar el JTextArea antes de mostrar los nuevos productos
        textAreaMostrar.setText("");

        // Mostrar los productos en el JTextArea
        for (ProductoCongeladoAgua producto : productosCongeladosAgua) {
        ...
        String productoFormateado = String.format(
               ...
               producto.getTemperaturaMantenimiento(), producto.getSalinidadAgua()
        );
    ...
    private void initComponents() {
        ...
        titulo.setText("Productos Congelados por Agua");
        getContentPane().add(titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 20, -1, -1));
        ...
        getContentPane().add(btnGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 470, -1, -1));
        ...
        getContentPane().add(btnMostrarProductos, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 470, -1, -1));
        ...
        getContentPane().add(btnVolver, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 470, -1, -1));

        textAreaMostrar.setVisible(false);
        getContentPane().add(textAreaMostrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 50, 410, 400));
        ...
        jLabel7.setText("Salinidad del Agua (%) : ");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 370, -1, -1));
        getContentPane().add(Txt1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 60, 240, 30));
        getContentPane().add(Txt2, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 110, 240, 30));
        getContentPane().add(Txt3, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 160, 240, 30));
        getContentPane().add(Txt4, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 210, 240, 30));
        getContentPane().add(Txt5, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 260, 240, 30));
        getContentPane().add(Txt6, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 310, 200, 30));
        getContentPane().add(Txt7, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 360, 240, 30));
    ...
    String fechaCaducidad = Txt2.getText();
        ...
        String salinidadAguaTexto = Txt7.getText();
    ...
    if (!nombreProducto.isEmpty() && !fechaCaducidad.isEmpty() && 
        ...
        try {
            ...
            double salinidadAgua = Double.parseDouble(salinidadAguaTexto);
            
            // Crea un nuevo ProductoCongelado con la información ingresada
            ProductoCongeladoAgua productoCongeladoAgua = new ProductoCongeladoAgua(
                nombreProducto, fechaCaducidad, numeroLote, fechaEnvasado, paisOrigen, tempMantenimiento, salinidadAgua);
                
                // Llama al método para guardar en el archivo de texto
            productoCongeladoAgua.guardarProductoEnArchivo();
